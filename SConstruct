...
opts.Add(PathVariable('target_name', 'The library name.', 'libverlet', PathVariable.PathAccept))

# Local dependency paths, adapt them to your setup
godot_headers_path = "../Babel/godot-cpp/godot-headers/"
cpp_bindings_path = "../Babel/godot-cpp/"
